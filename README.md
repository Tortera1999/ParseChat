...
1. Add avatars
2. Round up the labels

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://media.giphy.com/media/3o7WILBpyMGSWdNBkc/giphy.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
- Had problems implementing the server
- Had problems logging out
